...
const taskBadgeStyles: Record<string, string> = {
  "Multiple Choice Questions": "bg-sky-500/5 text-sky-600 dark:text-sky-400/90 border-sky-400/15 dark:border-sky-500/20",
  "Named-entity Recognition": "bg-emerald-500/5 text-emerald-600 dark:text-emerald-400/90 border-emerald-400/15 dark:border-emerald-500/20",
  "Relation Extraction": "bg-violet-500/5 text-violet-600 dark:text-violet-400/90 border-violet-400/15 dark:border-violet-500/20",
  "Multi-label Classification": "bg-amber-500/5 text-amber-600 dark:text-amber-400/90 border-amber-400/15 dark:border-amber-500/20",
  "Generation": "bg-rose-500/5 text-rose-600 dark:text-rose-400/90 border-rose-400/15 dark:border-rose-500/20",
};
...
function RouteComponent() {
  ...
  const badgeStyle = taskBadgeStyles[datasetMetadata?.taskName] ?? "bg-zinc-500/5 text-zinc-600 dark:text-zinc-400/90 border-zinc-400/15 dark:border-zinc-500/20";
